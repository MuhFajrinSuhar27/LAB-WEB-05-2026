...
<img width="620" height="160" alt="image" src="https://github.com/user-attachments/assets/4c6a80c6-d2e0-4af3-abe0-720dfef4eb58" />
...
3. Masuk ke foldermu dan pastikan status repositori aman:
   > `cd H071251nnn`
   > `git status`
   *(Pastikan terminal menunjukkan bahwa kamu berada di branch NIM-mu dan tidak ada error).*
